...
Ext.define('Jobbox.controller.history.Flowchart', {
  ...
  onDblclick: function(e) {
    ...
    me.onReset();
    var ctrl = Jobbox.app.getController('history.List');
  ...
  onDrawFlowchart: function(record) {
    ...
    if ('jobbox.model.histjobunitsStore' in record) {
      var store = record['jobbox.model.histjobunitsStore'];
    ...
    var ctrl = Jobbox.app.getController('history.JobunitTab');
  ...
  onDrawConnector: function(record, prev_job, next_job) {
    ...
    var flowchart = me.getHistoryFlowchart();
    var surface = flowchart.surface;
    var connector = new Jobbox.draw.ConnectorView(record, prev_job, next_job);
  ...
  onDrawJob: function(record) {
    ...
    var flowchart = me.getHistoryFlowchart();
    var surface = flowchart.surface;
    surface.add(new Jobbox.draw.JobView(record));
