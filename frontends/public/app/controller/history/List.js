...
Ext.define('Jobbox.controller.history.List', {
  ...
  onCellclick: function(grid, td, cellIndex, record, tr, rowIndex, e) {
    ...
    var ctrl = Jobbox.app.getController('history.Flowchart');
    ctrl.onReset();
  ...
  onLoadJobnet: function(id) {
    ...
    var ctrl = Jobbox.app.getController('history.Flowchart');
    Jobbox.model.HistJobunit.load(id, {
      failure: function(record) {},
      success: function(record) {
        JobboxSetForm(form, record);
  ...
  onSetInterval: function(item, e) {
    var me = this;
    jobbox_history_interval = item.interval;
    me.onSetIconCls();
  },
  ...
  onSetIconCls: function() {
    ...
    menuitems.forEach(function(item) {
      if (item.interval) {
        if (jobbox_history_interval == item.interval) {
          item.setIconCls('');
        } else {
