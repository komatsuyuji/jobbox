...
Ext.define('Jobbox.controller.editor.DrawTab', {
  ...
  onMouseDown: function(e, t, btn) {
    ...
    var pos_x = e.getPageX() - editordraw.getX() - JOBBOX_DRAW_WIDTH;
    var pos_y = e.getPageY() - editordraw.getY() - JOBBOX_DRAW_WIDTH;
    img.setSrc(btn.icon);
