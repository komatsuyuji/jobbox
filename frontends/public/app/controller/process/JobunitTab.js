...
Ext.define('Jobbox.controller.process.JobunitTab', {
  ...
  onLoadJobunit: function(record) {
    ...
    var me = this;
    Jobbox.model.ProcJobunit.load(record.data.id, {
  ...
  onLoadJobunitDetail: function(record) {
    ...
    var ctrl_execlog = Jobbox.app.getController('common.Execlog');
    var ctrl_variable = Jobbox.app.getController('common.Variable');
    var ctrl_sidebar = Jobbox.app.getController('process.Sidebar');
