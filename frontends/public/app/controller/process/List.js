...
Ext.define('Jobbox.controller.process.List', {
  ...
  onAfterrender: function(grid) {
    ...
    if (jobbox_login_user.data.kind == USER_KIND_MONITOR) {
  ...
  onCellclick: function(gridview, td, cellIndex, record, tr, rowIndex, e) {
    ...
    jobbox_topjobnet_id = record.data.proc_jobunit_id;
  ...
  onLoadJobnet: function(id) {
    ...
    Jobbox.model.ProcJobunit.load(id, {
