...
Ext.define('Jobbox.controller.process.Flowchart', {
  ...
  onDrawFlowchart: function(record) {
    ...
    if ('jobbox.model.procjobunitsStore' in record) {
      var store = record['jobbox.model.procjobunitsStore'];
    ...
    if (surface.selectedjob) {
      ...
      var ctrl = Jobbox.app.getController('process.JobunitTab');
