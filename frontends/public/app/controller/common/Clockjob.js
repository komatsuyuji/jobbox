...
Ext.define('Jobbox.controller.common.Clockjob', {
  ...
  onLoadRecord: function(record) {
    ...
    Jobbox.model.Jobunit.load(record.data.id, {
      success: function(rec) {
        var rec_clockjob = rec['Jobbox.model.ClockjobHasOneInstance'];
        if (rec_clockjob) {
          rec_clockjob.getProxy().url = location.pathname + '/jobunits/' + rec.data.id + '/clockjobs';
          JobboxSetForm(form_clockjob, rec_clockjob);
        }
      }
    });
  },
  ...
  onLoadProcRecord: function(record) {
    ...
    JobboxSetForm(form_jobunit, record);
    JobboxSetForm(form_clockjob, record['Jobbox.model.ClockjobHasOneInstance']);
  },
  ...
  onLoadHistRecord: function(record) {
    ...
    JobboxSetForm(form_jobunit, record);
    JobboxSetForm(form_clockjob, record['Jobbox.model.ClockHasOneInstance']);
  },
