...
Ext.define('Jobbox.controller.common.Varjob', {
  ...
  onLoadRecord: function(record) {
    ...
    Jobbox.model.Jobunit.load(record.data.id, {
      success: function(rec) {
        var store_vardatum = rec['jobbox.model.vardataStore'];
        if (store_vardatum) {
  ...
  onLoadProcRecord: function(record) {
    ...
    JobboxSetForm(form_jobunit, record);
    if (record['jobbox.model.vardataStore']) {
      grid_vardatum.reconfigure(record['jobbox.model.vardataStore']);
    }
  },
