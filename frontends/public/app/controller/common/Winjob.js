...
Ext.define('Jobbox.controller.common.Winjob', {
  ...
  onLoadRecord: function(record) {
    ...
    Jobbox.model.Jobunit.load(record.data.id, {
      success: function(rec) {
        var rec_winjob = rec['Jobbox.model.WinjobHasOneInstance'];
        if (rec_winjob) {
          rec_winjob.getProxy().url = location.pathname + '/jobunits/' + rec.data.id + '/winjobs';
          JobboxSetForm(form_winjob, rec_winjob);
        }
  ...
  onLoadProcRecord: function(record) {
    ...
    JobboxSetForm(form_jobunit, record);
    JobboxSetForm(form_winjob, record['Jobbox.model.WinjobHasOneInstance']);
