...
Ext.define('Jobbox.controller.common.Jobresult', {
  ...
  onLoadProcRecord: function(record) {
    ...
    var store_jobresult = record['jobbox.model.jobresultsStore'];

    JobboxSetForm(form_jobunit, record);
    if (store_jobresult) {
      store_jobresult.sort('id', 'DESC');
      JobboxSetForm(form_jobresult, store_jobresult.getAt(0));
    } else {
      JobboxSetForm(form_jobresult, null);
    }
  },
