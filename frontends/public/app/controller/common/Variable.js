...
Ext.define('Jobbox.controller.common.Variable', {
  ...
  onAddVariable: function(button, e) {
    ...
    var variable = new Jobbox.model.Variable({
  ...
  onLoadProcRecord: function(record) {
    ...
    if (record['jobbox.model.variablesStore']) {
      grid_variable.reconfigure(record['jobbox.model.variablesStore']);
    }
  },
