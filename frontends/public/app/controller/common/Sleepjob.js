...
Ext.define('Jobbox.controller.common.Sleepjob', {
  ...
  onLoadRecord: function(record) {
    ...
    Jobbox.model.Jobunit.load(record.data.id, {
      success: function(rec) {
        var rec_sleepjob = rec['Jobbox.model.SleepjobHasOneInstance'];
        if (rec_sleepjob) {
          rec_sleepjob.getProxy().url = location.pathname + '/jobunits/' + rec.data.id + '/sleepjobs';
          JobboxSetForm(form_sleepjob, rec_sleepjob);
        }
      }
    });
  },
  ...
  onLoadProcRecord: function(record) {
    ...
    JobboxSetForm(form_jobunit, record);
    JobboxSetForm(form_sleepjob, record['Jobbox.model.SleepjobHasOneInstance']);
  },
