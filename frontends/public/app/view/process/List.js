...
//
/////////////////////////////////////////////////////////////////////////////////
Ext.define('Jobbox.view.process.List', {
  ...
  columns: {
    items: [{
      ...
      renderer: function(value) {
        return JobboxFindRecord(TOPJOBNET_MODE_DATA, value);
      }
    }, {
      ...
      renderer: function(value, meta) {
        meta.style = JobboxMetaStyle(value);
        return JobboxFindRecord(JOBUNIT_STATUS_DATA, value);
      }
    }, {
      ...
      width: 100,
      renderer: function(value) {
        return JobboxFindRecord(ROOTJOBNET_RUNTYPE_DATA, value);
      }
    }, {
