...
//
/////////////////////////////////////////////////////////////////////////////////
Ext.define('Jobbox.view.common.Datecond', {
  ...
  columns: {
    items: [{
      ...
      renderer: function(value) {
        return JobboxFindRecord(DATECOND_KIND_DATA, value);
      }
    }, {
      ...
      renderer: function(value, metaData, record) {
        switch (record.data.kind) {
          ...
          case DATECOND_KIND_FOURTH_WEEK:
            {
              return JobboxFindRecord(JOBBOX_DAYOFWEEK_DATA, value);
              break;
            }
          case DATECOND_KIND_EVERY_MONTH:
          case DATECOND_KIND_REVERSE_MONTH:
      ...
      renderer: function(value, metaData, record) {
        if (record.data.kind == DATECOND_KIND_CALENDAR) {
          var store = Jobbox.app.getStore('Calendar');
